...
class DataUtils {
    ...
    private val darwinAwards = Category(1, "Darwin Awards")
    private val criminal = Category(1, "Criminal")
    private val animals = Category(1, "Animals")
    private val music = Category(1, "Music")

    val newsList = mutableListOf<NewsItem>().apply {
        add(
            NewsItem(
                1,
        ...
        add(
            NewsItem(
                ...
                "A huge haul of cocaine was discovered hidden in boxes of bananas donated to the Texas Department of Criminal "
                        + "Justice.\n\n"
                        + "Some 45 boxes of bananas from Ports of America in Free-port were given away to the agency because they "
                        + "were already ripe.\n\n"
        ...
        add(
            NewsItem(
                ...
                "The Scottish band, who are best-known for their 1994 cover of The Troggs' 1960s hit Love Is All Around, "
                        ...
                        + "Simm, from Lancashire, first shot to fame on ITV talent show Pop stars in 2001 after forming the group "
                        ...
                        + " opportunity to join a band with such amazing songs and great guys and a great fan-base really "
                        + "excites me.\n\n"
